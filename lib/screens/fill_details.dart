...
import 'package:demo/screens/story_page.dart';
...
class _HomePageState extends State<FillDetails> {
  @override
      ...
      child: Scaffold(
        body: Column(
          ...
          children: [
           ...
           const Center(child:Text('Fill Details',style: TextStyle(color: Colors.purple,fontSize: 30,),)),
           const SizedBox(height: 50,),
           PhoneCard(assetImage:const AssetImage('images/SIGNUP.png'),),
